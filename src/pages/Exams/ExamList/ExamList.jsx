...
import styles from './Card.module.css'  // Styles for the card component
import { NavLink } from "react-router-dom"  // NavLink to handle routing
import classes from "./ExamList.module.css"  // Styles for the exam list page
import Loader from "../../../components/Loader/Loader"  // Loader component to show loading state
import Alert from '../../../components/Alert/Snackbar'  // Alert component to show errors
import Navbar from "../../../components/Navigation/navbar"  // Navbar component

import { useContextPilotPass } from "../../../Context"  // Custom context to fetch exams data

const examList = () => {

    // Destructure required values from context
    const { fetchExams, ExamResponse, error, loading } = useContextPilotPass()
