...
import styles from './Card.module.css'; // Import custom styles for the card
import { NavLink } from "react-router-dom"; // Used for routing between different quiz pages
import classes from "./QuizList.module.css"; // Import styles specific to the QuizList component
import Loader from "../../../components/Loader/Loader"; // Loader component to show while data is being fetched
import Alert from '../../../components/Alert/Snackbar'; // Alert component for displaying error messages
import Navbar from "../../../components/Navigation/navbar"; // Navbar component for navigation
import { useContextPilotPass } from "../../../Context"; // Custom context hook for managing global state
